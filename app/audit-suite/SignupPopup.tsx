 ...
 *
 * A sibling of app/tracking-suite/SignupPopup.tsx — same behaviour, its own
 * session key and its own funnel placement, so the two campaigns never suppress
 * or report over each other. It asks for the signup nine seconds in, once the
 * visitor has had time to see what the page is actually selling. Nine rather
 * than five: an interstitial that lands before the reader has finished the
 * headline is the one they close without reading.
 *
    ...
    <div className="ads-popup" role="dialog" aria-modal="true" aria-labelledby="ads-popup-title">
      ...
      <div className="ads-popup-card">
        ...
        <p className="ads-popup-body">
          Sign up and get <b>100 free credits every month</b> to audit your site, analyse your
          competitors and find your next keywords.
        </p>

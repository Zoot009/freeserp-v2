      ...
      <div className="fs-maps-shot" style={{ maxWidth: 1320, margin: "0 auto", padding: "0 60px" }}>
        <Reveal>
          ...
          >
            <Image
              src={SCAN_SHOT.src}
              alt="google maps rank tracker — a finished Maps scan over New York showing ranked search points on the map, the business's visibility score, and the competitors holding the top-3 spots"
              title="Google Maps rank tracker results"
              width={SCAN_SHOT.w}
              height={SCAN_SHOT.h}
              priority
...
export function StepCards() {
  return (
    ...
    >
      <SectionHead
        tag="Step By Step"
        title="How the Google Maps rank checker works"
        sub="Pick your business, name the searches, draw the area. Every point on the map is a real Google Maps search run from those exact coordinates."
      />
      <div

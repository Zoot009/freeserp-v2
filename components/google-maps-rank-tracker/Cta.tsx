    ...
    <section style={{ padding: "100px 0 80px" }}>
      ...
      >
        <Reveal>
          ...
          >
            Find out where you really rank on Maps
          </h2>
          <p
            style={{
              color: "#fff",
          ...
          >
            Pick your business, add a keyword, set your area. Your first Google Maps rank check
            costs 3 credits of the 100 you get free every month.
          </p>

    ...
    <section style={{ padding: "100px 0 80px" }}>
      ...
      >
        <Reveal>
          ...
          >
            Start tracking where it counts
          </h2>
          <p
            style={{
              color: "#fff",
          ...
          >
            Add a keyword, set the city or postcode your customers search from, and get a real
            position instead of a national average. One credit a check, 100 free every month.
          </p>

    ...
    <section style={{ padding: "100px 0 80px" }}>
      ...
      >
        <Reveal>
          ...
          >
            See the shape of your local visibility
          </h2>
          <p
            style={{
              color: "#fff",
          ...
          >
            Centre a grid on your business, pick a keyword, and find out how far your Map Pack
            position really reaches. A 3×3 costs 3 of the 100 credits you get free each month.
          </p>
